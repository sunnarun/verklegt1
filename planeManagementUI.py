...
class PlaneManagementUI():
    ...
    def display_info_to_edit(self):
        ...
        print('''|‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾|''')
        print('''| (1) Aircraft registration: {:19}|'''.format(self.registration))
        print('''| (2) Aircraft type: {:27}|'''.format(self.plane_type))
        print('''| (3) Aircraft manufacturer: {:19}|'''.format(self.manufacturer))
        print('''| (4) Number of seats: {:25}|'''.format(self.seats))
        print('''|                                           |''')
        print(''' ‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾''')
        print()
